...
def main(arguments):
    ...
    # print(args)               # Namespace(data_dir='glue_data', path_to_mrpc='', tasks='all')
    ...
    for _,task in enumerate(tasks):
        print(_,task,args.data_dir, args.path_to_mrpc)
        if(1):
        # print(0/0)
            if task == 'MRPC':
                print("pass")  # format_mrpc(args.data_dir, args.path_to_mrpc)
